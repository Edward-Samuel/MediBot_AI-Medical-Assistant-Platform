        ...
        {isCalendarConnected ? (
          connectedCalendarId ? (
            <div className="mt-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
              ...
              <div className="p-8 bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/10 dark:to-blue-900/10">
                <div className="max-w-2xl mx-auto text-center">
                  <div className="mb-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-6">
                      Your appointments are automatically syncing with <strong>{connectedCalendarId}</strong>
                    </p>
                  </div>

                  <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700 mb-6">
                    <h4 className="font-semibold text-gray-900 dark:text-white mb-4">What's Syncing:</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-900 dark:text-white">New Appointments</p>
                          <p className="text-xs text-gray-500 dark:text-gray-400">Automatically added to calendar</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <svg className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-900 dark:text-white">Google Meet Links</p>
                          <p className="text-xs text-gray-500 dark:text-gray-400">Video call links included</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <svg className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-900 dark:text-white">Reschedules</p>
                          <p className="text-xs text-gray-500 dark:text-gray-400">Updates sync instantly</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        <svg className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-900 dark:text-white">Cancellations</p>
                          <p className="text-xs text-gray-500 dark:text-gray-400">Removed from calendar</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition-colors shadow-sm"
                    >
                    ...
                    <a
                      ...
                      className="inline-flex items-center justify-center px-6 py-3 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 text-gray-900 dark:text-white rounded-lg font-medium transition-colors shadow-sm border border-gray-300 dark:border-gray-600"
                    >
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      💡 <strong>Tip:</strong> All your MediBot appointments will appear in your Google Calendar app on all your devices
                    </p>
                  </div>
                </div>
              </div>
